...
<html xmlns="http://www.w3.org/1999/xhtml">
        <head>
                ...
                <title>Confirmacion Subscripcion | XII Simposio</title>
                <style type="text/css">
                        /* ------------------------------------- 
                                GLOBAL 
                        ------------------------------------- */
                                ...
                                <td class="container" bgcolor="#FFFFFF">
                                                ...
                                                <table>
                                                        <tr>
                                                                <td>
                                                                        ...
                                                                        <p class="lead">
                                                                                El solicitante declaró los siguientes datos:
                                                                        </p>
									<table class="data_table">
										...
										{{ end }}
                                                ...
                                                <p class="callout">
                                                        Este correo electrónico fue generado automáticamente, si encuentra
                                                        algún error escriba a <a href="mailto:carlos.a.frias@gmail.com">carlos.a.frias@gmail.com</a>.
                                                </p>
                                        </div>
                                </td>
                        </tr>
